...
The `skills/docs` directory is canonical; generated status applies only to adapters. The cross-harness pilots and universal compatibility claim are deliberately deferred to Task 6.
