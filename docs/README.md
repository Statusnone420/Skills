...
Public narrative: [root README](../README.md) → [getting started](../GETTING_STARTED.md) → [installation](../INSTALL.md) → [commands](../COMMANDS.md).
...
Internal implementation plans and worker reports are deliberately excluded from the public documentation map. Durable product status lives in [current state](STATE.md), the [roadmap](../ROADMAP.md), and evidence pages linked above.
