...
2. Start with `$docs doctor`; its initial result is read-only and explains repository health, evidence, and any proposed treatment IDs. Expected result: no file changes on this first pass.
